...
namespace PGSH.Infrastructure.Migrations
{
    ...
    [Migration("20251031141754_AddingUserOwnedTypes")]
    partial class AddingUserOwnedTypes
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSH.Domain.Hospitals.Service", b =>
                {
                    ...
                    b.Property<Guid?>("_serviceChefId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PGSH.Domain.Hospitals.Service", b =>
                {
                    ...
                    b.HasOne("PGSH.Domain.Employees.Employee", "_serviceChef")
                        .WithMany()
                        .HasForeignKey("_serviceChefId")
            ...
            modelBuilder.Entity("PGSH.Domain.Registrations.Registration", b =>
                {
                    ...
                    b.OwnsOne("PGSH.Domain.Common.Utils.Level", "Level", b1 =>
                        {
                            b1.Property<Guid>("RegistrationId")
                                .HasColumnType("uuid");

                            b1.Property<int>("AcademicProgram")
                                .HasColumnType("integer");
