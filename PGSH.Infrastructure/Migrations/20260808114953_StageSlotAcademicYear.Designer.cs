...
namespace PGSH.Infrastructure.Migrations
{
    ...
    [Migration("20260808114953_StageSlotAcademicYear")]
    partial class StageSlotAcademicYear
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PGSH.Domain.Stages.Curriculum", b =>
                {
                    ...
                    b.HasIndex("LevelId", "AcademicYearId")
                        .IsUnique()
                        .HasDatabaseName("IX_Curriculum_Level_Year");
