# SMOKE-TEST-ARCHIVE.md

Smoke-test sections **§0 – §19**, covering sessions 11 → 23. Split out of `SMOKE-TEST.md` on
2026-09-06; all of them were executed at the time. Kept because each records the numbers the base
actually printed, which is what a later regression is measured against.

The current pass is in [`SMOKE-TEST.md`](SMOKE-TEST.md).

⚠ Section numbering here is the original and is **not** sequential — the 12x variants were added
out of order as the sessions ran.
